...
{
    public class SetupResultsPageAttribute : SetupPageAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            var query = filterContext.HttpContext.Request.Params["Query"];
